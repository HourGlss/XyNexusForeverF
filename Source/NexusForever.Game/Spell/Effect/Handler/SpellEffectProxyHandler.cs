...
namespace NexusForever.Game.Spell.Effect.Handler
{
    ...
    public class SpellEffectProxyHandler : ISpellEffectApplyHandler<ISpellEffectProxyData>
    {
        ...
        /// </summary>
        public void Apply(ISpell spell, IUnitEntity target, ISpellTargetEffectInfo info, ISpellEffectProxyData data)
        {
            ...
            spell.AddProxy(new Proxy(target, data, spell, spell.Parameters));
        }
    }
}
