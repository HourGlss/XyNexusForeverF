    ...
    public class PathMission
    {
        ...
        private void Complete()
        {
            ...
            if (episodeReward.Item2Id > 0)
                player.Inventory.ItemCreate(InventoryLocation.Inventory, episodeReward.Item2Id, 1, ItemUpdateReason.PathReward);
        ...
        private void SendProgressUpdate()
        {
            ...
            {
                PathMissionId             = (ushort)Entry.Id,
                Completed                 = complete,
                ObjectiveCompletionFlags  = Progress,
                StateFlags                = (uint)(complete ? 0 : 1)
            });
        }
    }
}
